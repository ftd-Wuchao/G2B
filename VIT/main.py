...
def get_args_parser():
    ...
    parser.add_argument('--add_mask', default=False, action='store_true',
                        help='')
    ...
    parser.add_argument('--rehearsal_test_trsf', default=False, action='store_true',
                        help='Augment wo trsf')
...
def main(args):
    ...
    if args.name:
        ...
        args.output_dir = os.path.join(
            args.output_basedir,
            f"{args.data_set}-{args.initial_increment}-{args.increment}_{args.name}_{args.trial_id}"
        )
    else:
        log_store = None
            ...
            if args.save_every_epoch is not None and epoch % args.save_every_epoch == 0:
                if os.path.isdir(args.resume):
                    ...
                    for checkpoint_path in checkpoint_paths:
                        ...
                        #     'args': args,
                        # }, "/home/share/wuchao/IL/Dytox1/"+args.name+f'checkpoint_{task_id}.pth')
