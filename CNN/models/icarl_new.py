...
from utils.inc_net import IncrementalNet, Mask_IncrementalNet
...
class iCaRL_new(BaseLearner):

    def __init__(self, args):
        super().__init__(args)
        self._network = Mask_IncrementalNet(args['convnet_type'], False)
        # self.sup_loss = TripletLoss(margin = 0.1)
    ...
    def _update_representation(self, train_loader, test_loader, optimizer, scheduler):
        ...
        for _, epoch in enumerate(prog_bar):
            ...
            for i, (_, inputs, targets) in enumerate(train_loader):
                ...
                loss = loss_clf + 0.5 * loss_aux + loss_kd
