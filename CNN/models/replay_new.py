...
class Replay(BaseLearner):
    ...
    def incremental_train(self, data_manager):
        ...
        # if self.args['convnet_type'] == "cifar_attention_resnet18":
        #     if self._cur_task==0:
        #         self._network.convnet.append_attention_net()
    ...
    def _update_representation(self, train_loader, test_loader, optimizer, scheduler):
        ...
        for _, epoch in enumerate(prog_bar):
            ...
            for i, (_, inputs, targets) in enumerate(train_loader):
                ...
                loss_kd_mask = _MKD_loss(mask, self._old_network(inputs)["mask"])  # _MKD_loss  features_distillation8
                #loss_kd_mask = _NMKD_loss(mask, self._old_network(inputs)["mask"], neg_mask) # _MKD_loss  features_distillation8

                loss_clf=F.cross_entropy(logits,targets)
                loss=loss_clf+loss_kd_mask
