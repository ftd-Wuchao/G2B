...
from utils.inc_net import IncrementalNetWithBias, Mask_IncrementalNetWithBias
...
class BiC(BaseLearner):
    def __init__(self, args):
        super().__init__(args)
        self._network = Mask_IncrementalNetWithBias(args['convnet_type'], False, bias_correction=True)
